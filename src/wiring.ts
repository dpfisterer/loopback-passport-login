...
// import {AuthenticateActionProvider} from './AuthenticateAction.provider';

export async function setupBindings(app: Application) {
  ...
  registerAuthenticationStrategy(app, GoogleOauth2Authentication);
